...
from .gconvbase import GConvolutionalFullWeights


### Implementations of specific full-weight group-convolutional kernels where the groupelements at specific locations
# have their own weights.
#
# Most basic group-convolutional kernel in chapter 5.2.2 "Weighted Group-Convolutional Kernel".


class D4ConvolutionalFullWeights(GConvolutionalFullWeights):
    r"""
    """
    def __init__(
        self,
...
class D2ConvolutionalFullWeights(GConvolutionalFullWeights):
    r"""
    """
    def __init__(
        self,
...
class RotationConvolutionalFullWeights(GConvolutionalFullWeights):
    r"""
    """
    def __init__(
        self,
...
class Rotation180ConvolutionalFullWeights(GConvolutionalFullWeights):
    r"""
    """
    def __init__(
        self,
...
class FlipLeftRightConvolutionalFullWeights(GConvolutionalFullWeights):
    r"""
    """
    def __init__(
        self,
...
class FlipUpDownConvolutionalFullWeights(GConvolutionalFullWeights):
    r"""
    """
    def __init__(
        self,
