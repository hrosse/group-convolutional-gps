...
from .gconvbase import GInvarPatchesConvolutional


### Implementation of specific group-convolutional kernels where w_pg=w_p.
#
# Conceptually a group-convolutional GP with a group-invariant patch-response-function.
# As described in chapter 5.2.2 "Weighted Group-Convolutional Kernel".
# The kernel itself is not invariant but double-sum over group elements can still be changed to 
# a single-sum as in chapter 5.2.3 "Interdomain Inducing Variables for Group-Convolutional Gaussian Processes".


class D4InvarPatchesConvolutional(GInvarPatchesConvolutional):
    r"""
    """
    def __init__(
        self,
...
class D2InvarPatchesConvolutional(GInvarPatchesConvolutional):
    r"""
    """
    def __init__(
        self,
...
class RotationInvarPatchesConvolutional(GInvarPatchesConvolutional):
    r"""
    """
    def __init__(
        self,
