"""
===========================================================
 Experiment rotated MNIST: 0-vs-1
===========================================================

This script provides pipelines for the 0-vs-1 experiments with rotated version
...
def parse_args():
    ...
    parser.add_argument("--save_dir", type=str, default="./checkpoints/mnist_rot01",
...
def build_model(Xtrain, arg_dict):
    # The block below is used as standard values in experiments.
    # Values might be changed in the code blocks where specific models are build. 
    var_init_image = 1.0
    var_init_patch = 1.0
    ...
    # A plot of weights appears to show some symmetry with respect to rotations.
