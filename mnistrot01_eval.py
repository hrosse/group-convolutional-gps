"""
===========================================================
 Evaluation Script: rotated MNIST 0-vs-1
===========================================================

This script provides a pipeline for the evaluation of the 0-vs-1 experiments 
...
from mnistrot01 import load_data, build_model, get_optimizer
...
def parse_args():
    ...
    parser.add_argument("--result_dir", type=str, default="./results/mnist_rot01",
